...
export default function SlopCreatorShopStage({
  ...
  return (
    <section className="slop-creator-shop" aria-label="Creator inventory stage">
      <header className="slop-creator-shop-header">
        <SlopTitle as="h2" size="md" className="slop-creator-shop-title">Inventory</SlopTitle>
        <div className="slop-creator-shop-tabs" role="tablist" aria-label="Inventory categories">
          {shopTabs.map((tab) => (
            <button
              key={tab.key}
              type="button"
      ...
      {activeTab === "home" ? (
        <>
          ...
          <section className="slop-creator-shop-section">
            <div className="slop-creator-shop-section-head">
              <SlopTitle as="h3" size="sm" className="slop-creator-shop-section-title">Stored Pieces</SlopTitle>
        ...
        <section className="slop-creator-shop-section is-category-only">
          <div className="slop-creator-shop-section-head">
            <SlopTitle as="h3" size="sm" className="slop-creator-shop-section-title">
              {`${shopTabs.find((tab) => tab.key === activeTab)?.label} Locker`}
            </SlopTitle>
